    ...
    <div class="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
      <div class="flex items-center justify-between">
        ...
        <button 
          type="button"
          id="menu" 
          class="-m-2.5 rounded-md p-2.5 text-gray-700" onclick="document.getElementById('menu').classList.toggle('hidden')">
          <span class="sr-only"
          >Close menu</span>
          <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
          ...
          <div class="space-y-2 py-6">
            <div class="-mx-3">
              <button 
                ...
                onclick="document.getElementById('disclosure-1').classList.toggle('hidden')" 
              ...
              <div 
                class="mt-2 space-y-2 <?= $isOpen ? '' : 'hidden'; ?>" 
                id="disclosure-1">
