          ...
          <div class="flex items-center">
            ...
            <div class="hidden md:block">
              <div class="ml-10 flex items-baseline space-x-4">
                ...
                <a href="/" class="<?= navStyle('/'); ?>" aria-current="page">Home</a>
                <a href="/about" class="<?= navStyle('/about'); ?>">About</a>
                <a href="/notes" class="<?= navStyle('/notes'); ?>">Notes</a>
                <a href="/contact" class="<?= navStyle('/contact'); ?>">Contact</a>
              </div>
            </div>
          </div>
          <div class="hidden md:block">
            <div class="ml-4 flex items-center md:ml-6">
              ...
              <div class="relative ml-3">
                  ...
                  <button type="button" class="flex max-w-xs items-center rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                    ...
                    <?php if ($_SESSION['user'] ?? false) : ?>
                      <img 
                        ...
                        onclick="document.getElementById('_menu').classList.toggle('hidden')"
                      >
                    <?php else : ?>
                ...
                -->
                <?php if ($_SESSION['user'] ?? false) : ?>
                  <div class="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none hidden" role="menu" id="_menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
