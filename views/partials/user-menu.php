...
<div>
          ...
          <div 
            id="user-menu"
            class="absolute right-0 z-10 mt-3 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none <?= $isOpen ? '' : 'hidden'; ?>" 
            role="menu" 
