   ...
   <div class="w-full border border-gray-200 rounded-lg bg-gray-50 border-gray-300">
      <div class="px-4 pt-2 bg-white rounded-t-lg">
            ...
            <textarea 
              ...
              placeholder="Title"><?= $_POST['title'] ?? '' ?></textarea>
      </div>
            ...
            <div>
                ...
                <div 
                  ...
                  Test <?php echo $note['id']; ?>
                    ...
                    <a href="#edit/<?= $note['id'] ?>">
                        <button 
                            id="note-edit-btn-<?= $index ?>"
                            data-id="<?= $note['id'] ?>"
                            type="button"
                            class="w-6 h-6 rounded-full bg-blue-700 text-white flex items-center justify-center hover:bg-blue-800 transition-transform" 
